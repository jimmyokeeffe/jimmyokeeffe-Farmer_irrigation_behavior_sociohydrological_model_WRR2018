...
## Parameter file for Hamirpur district
...
## surface elevation
surface_elev_masl = 129 ## actual elevation above sea level **checked**
...
runoff_coef = 0.9            ## **calibration**
evaporation_loss_coef = 0.64 ## **calibration**
## runoff_coef = 0.9            ## **checked**
## evaporation_loss_coef = 0.75 ## **checked**
return_flow_coef = 0.45      ## **checked** (not used in new groundwater model)

## canal volume and leakage coefficient
canal_volume = 0             ## **checked**
canal_leakage_coef = 0       ## **checked**
...
wheat_yield_coeff = 2.8      ## **calibration**
## wheat_yield_coeff = 1.9      ## **checked**
...
rooting_depth_wheat = c(320,106,1.1)        ## **checked**
...
wheat_min = 0.10                            ## **checked**
wheat_max = 0.24                            ## **checked**
rice_min = 0                                ## **checked**
rice_max = 0                                ## **checked**
...
well_depth3_masl = surface_elev_masl - 60   ## **checked**
