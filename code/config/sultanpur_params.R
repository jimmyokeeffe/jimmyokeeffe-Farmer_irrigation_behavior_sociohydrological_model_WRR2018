...
farm_area = 10000 ## m2 (i.e. one hectare)
...
## surface elevation
surface_elev_masl = 103 ## actual elevation above sea level **checked**

## initial head
H_init_masl = surface_elev_masl - 5 ## **checked**

## root zone parameters
field_capacity = 0.3         ## **checked**
...
evaporation_loss_coef = 0.591## **calibration**
## runoff_coef = 0.95           ## **checked**
## evaporation_loss_coef = 0.8  ## **checked**
...
wheat_yield_coeff = 2.4      ## **calibration**      
## wheat_yield_coeff = 2.1      ## **checked**      
rice_yield_coeff = 1.7       ## **checked**
...
rooting_depth_rice  = c(148,296,0.65)       ## **checked**
...
wheat_min = 0.1                             ## **checked**
wheat_max = 0.2                             ## **checked**
rice_min = 0.1                              ## **checked**
rice_max = 0.3                              ## **checked**

## well depths associated with categories 1-3
well_depth1_masl = surface_elev_masl - 20   ## **checked**
well_depth2_masl = surface_elev_masl - 40   ## **checked**
well_depth3_masl = surface_elev_masl - 80   ## **checked**

## farmer parameters
## #################

## category probability
cat_prob = c(0.9,0.1,0.0)
